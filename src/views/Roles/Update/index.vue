  ...
  <div class="flex flex-col items-center">
    <el-card class="w-full width-100">
      ...
      <el-form
        ...
        ref="form"
        label-width="120px"
        class="demo-ruleForm store--form"
      >
        ...
        <el-form-item class="fl-right">
          <el-button type="primary" size="medium" @click="onSave"
            >Қўшиш</el-button
          >
          <router-link
            :to="{ name: 'Roles' }"
            class="el-button el-button--info is-plain el-button--medium"
            >Ортга қайтиш</router-link
          >
        </el-form-item>
      </el-form>
    </el-card>
